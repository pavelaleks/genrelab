...
with tab_help:
    ...
    <details open style="margin-bottom:1rem;">
        ...
        <div style="margin-top:0.75rem; padding-left:0.5rem;">
            ...
            <p><strong>4. Вкладки.</strong> Сверху: Как пользоваться, Генератор историй, Анализ текста, Narrative Playground.</p>
        </div>
    </details>
    """, unsafe_allow_html=True)
    ...
    # 3. Narrative Playground — три блока на details/summary
