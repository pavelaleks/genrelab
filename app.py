...
# ==================== ВКЛАДКА 3: НАРРАТИВНАЯ ПЕСОЧНИЦА ====================
    ...
    **Нарративная песочница** — экспериментальная площадка для изучения трансмедиальности,
    ...
    st.caption("💡 **Для сценаристов:** Узлы — это сцены или ключевые точки. Выберите тип структуры под задачу; пояснения — в раскрывающемся списке ниже.")
    st.markdown("""
    ...
    st.caption("💡 **Для сценаристов и писателей:** Один и тот же эпизод можно переложить в пьесу, сценарий, подкаст или игровую сцену — удобно для питчей, адаптаций и проверки «звучания» в другом формате.")
    st.markdown("""
